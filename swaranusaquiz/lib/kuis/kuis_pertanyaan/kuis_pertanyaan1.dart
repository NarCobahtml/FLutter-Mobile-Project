...
import '../kuis_benar/kuis_benar1.dart';
import '../kuis_salah/kuis_salah1.dart';
  ...
  Widget _buildQuestionImage() {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Image.asset('assets/image/gambar_tifa.png', fit: BoxFit.cover),
      ),
    );
  }
